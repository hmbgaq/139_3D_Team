...
class CVampireCommander_Leap_Loop : public CVampireCommander_Attack
{
public:
...
public:
	static const _uint g_iAnimIndex = CVampireCommander::VampireCommander_State::VampireCommander_Leap_01_Loop;
