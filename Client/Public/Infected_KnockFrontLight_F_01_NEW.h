...
class CInfected_KnockFrontLight_F_01_NEW : public CInfected_State_Knock
{
public:
...
public:
	static const _uint g_iAnimIndex = CInfected::Infected_State::Infected_KnockFrontLight_F_01_NEW;
