...
class CVampireCommander_Leap_Stop : public CVampireCommander_Attack
{
public:
...
public:
	static const _uint g_iAnimIndex = CVampireCommander::VampireCommander_State::VampireCommander_Leap_01_Stop;
