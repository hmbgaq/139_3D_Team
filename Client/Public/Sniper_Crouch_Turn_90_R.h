...
class CSniper_Crouch_Turn_90_R : public CBandit_Sniper_State_Cover
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Sniper_Crouch_Turn_90_R;
