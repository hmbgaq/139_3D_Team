...
class CVampireCommander_Spawn2 : public CVampireCommander_Spawn
{
public:
...
public:
	static const _uint g_iAnimIndex = CVampireCommander::VampireCommander_State::VampireCommander_Spawn_03;
