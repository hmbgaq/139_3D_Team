...
/* 체력 프레임 */
class CUI_TalkBox final : public CUI_Text
{
private:
	CUI_TalkBox(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strPrototypeTag);
	CUI_TalkBox(const CUI_TalkBox& rhs);
	virtual ~CUI_TalkBox() = default;
...
public:
	static CUI_TalkBox* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strPrototypeTag); //! 원형객체 생성
