...
class CSniper_CoverHigh_Side_L_Stop : public CBandit_Sniper_State_Cover
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Sniper_CoverHigh_Side_L_Stop;
