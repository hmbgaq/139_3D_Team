...
class CMotherMouth_SpittingMineStart : public CMotherMouth_State_Normal
{
public:
...
public:
	static const _uint g_iAnimIndex = CMotherMouth::MotherMouth_State::Parasiter_SpittingMines_Start_1800;
