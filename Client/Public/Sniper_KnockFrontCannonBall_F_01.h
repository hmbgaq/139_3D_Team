...
class CSniper_KnockFrontCannonBall_F_01 : public CBandit_Sniper_State_Hit
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Bandit_KnockFrontCannonball_F_01;
