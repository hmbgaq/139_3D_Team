...
class CTank_MeleeDynamicShield_05_FollowUp_01 : public CTank_State_Attack_Shield
{
public:
...
public:
	static const _uint g_iAnimIndex = CTank::Tank_State::Tank_MeleeDynamicShield_05_FollowUp_01;
