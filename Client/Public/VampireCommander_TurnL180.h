...
class CVampireCommander_TurnL180 : public CVampireCommander_State_Normal
{
public:
...
public:
	static const _uint g_iAnimIndex = CVampireCommander::VampireCommander_State::VampireCommander_Turn_L180;
