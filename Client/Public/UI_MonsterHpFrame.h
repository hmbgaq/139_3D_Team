...
private:
	CUI_MonsterHpFrame(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
...
public:
	static CUI_MonsterHpFrame* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext); //! 원형객체 생성
