...
class CVampireCommander_HitCenter : public CVampireCommander_Hit
{
public:
...
public:
	static const _uint g_iAnimIndex = CVampireCommander::VampireCommander_State::VampireCommander_HitNormal_F_03;
};
