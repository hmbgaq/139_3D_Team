...
class CBanditHeavy_StrongSlamDouble : public CBandit_Heavy_State_Attack
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Heavy::Bandit_Heavy_State::BanditHeavy_StrongSlamDouble;
