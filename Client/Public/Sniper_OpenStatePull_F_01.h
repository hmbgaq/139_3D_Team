...
class CSniper_OpenStatePull_F_01 : public CBandit_Sniper_State_Hit
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Infected_OpenStatePull_F_01;
