...
class CSniper_MeleeDynamic_02 : public CBandit_Sniper_State_Melee
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Sniper_MeleeDynamic_02;
