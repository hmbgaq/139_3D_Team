...
class CVampireCommander_Walk_FL45 : public CVampireCommander_State_Walk
{
public:
...
public:
	static const _uint g_iAnimIndex = CVampireCommander::VampireCommander_State::VampireCommander_Walk_FL45;
