...
class CEvent_MosnterSpawnTrigger final : public CEvent_Trigger
{
public:
...
protected:
			 CEvent_MosnterSpawnTrigger(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	virtual ~CEvent_MosnterSpawnTrigger() = default;
...
public:
	static CEvent_MosnterSpawnTrigger* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, void* pArg);
