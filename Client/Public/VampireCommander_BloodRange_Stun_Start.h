...
class CVampireCommander_BloodRange_Stun_Start : public CVampireCommander_Attack
{
public:
...
public:
	static const _uint g_iAnimIndex = CVampireCommander::VampireCommander_State::VampireCommander_BloodRange_02_Stun_Start;
