...
class CBanditHeavy_KnockFrontCannonball_F_01 : public CBandit_Heavy_State_Knock
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Heavy::Bandit_Heavy_State::BanditHeavy_KnockFrontCannonball_F_01;
