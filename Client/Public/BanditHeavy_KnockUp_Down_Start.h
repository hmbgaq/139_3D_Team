...
class CBanditHeavy_KnockUp_Down_Start : public CBandit_Heavy_State_Knock
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Heavy::Bandit_Heavy_State::BanditHeavy_KnockUp_Down_Start;
