...
class CSniper_KnockUp_Low_Fixed : public CBandit_Sniper_State_Hit
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Bandit_KnockUp_Low_Fixed;
