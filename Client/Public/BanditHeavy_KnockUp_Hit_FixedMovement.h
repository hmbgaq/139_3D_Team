...
class CBanditHeavy_KnockUp_Hit_FixedMovement : public CBandit_Heavy_State_Knock
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Heavy::Bandit_Heavy_State::BanditHeavy_KnockUp_Hit_FixedMovement;
