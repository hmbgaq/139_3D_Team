...
class CBanditHeavy_DeathHeavy_F_01 : public CBandit_Heavy_State_Death
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Heavy::Bandit_Heavy_State::BanditHeavy_DeathHeavy_F_01;
