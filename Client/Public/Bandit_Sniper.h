...
public:
	enum Bandit_Sniper_State
	{
		...
		Sniper_CoverHigh_Idle			, // ▶◀ (1) (Cover / Sniping)
		Sniper_CoverHigh_Reload			, // ▶◀ (2) (Cover / Sniping)
		Sniper_CoverLow_Idle			, // ▶◀ (3) (Cover / Sniping) 방어막 있을때 
		Sniper_CoverLow_Over_Start		, // ▶◀ (4) (Cover / Sniping)
		Sniper_CoverLow_Over_AimPose	, // ▶◀ (5) (Cover / Sniping)
		Sniper_CoverLow_Over_Stop		, // ▶◀ (6) (Cover / Sniping)
		Sniper_CoverLow_Reload			, // ▶◀ (7) (Cover / Sniping)
		Sniper_Crouch_Idle				, // ▶◀ (8) (Cover / Sniping) 방어막 없을때 
		Sniper_Crouch_Start				, // ▶◀ (9) (Cover / Sniping)
		Sniper_Crouch_Stop				, // ▶◀(10) (Cover / Sniping)
		Sniper_Crouch_Turn_90_R			, // ▶◀(11) (Cover / Sniping)
		Sniper_Crouch_Turn_90_L			, // ▶◀(12) (Cover / Sniping)
		Sniper_IdlePose					, // ▶◀(13) (Idle)
		Sniper_Idle						, // ▶◀(14) (Idle)
		Sniper_Taunt_03					, // ▶◀(15) (Cover / Sniping)
		Sniper_Taunt_02					, // ▶◀(16) (Cover / Sniping)
		Sniper_Taunt_01					, // ▶◀(17) (Cover / Sniping)
		Sniper_DeathLight_F_01			, // ▶◀(18) (Death)
		Sniper_DeathLight_B_01			, // ▶◀(19) (Death)
		Sniper_KnockFrontLight_F_02		, // ▶◀(20) (Hit) 오른쪽으로 맞아서 뒤로 넘어진뒤 다시 일어남 - 정면응시 
		Sniper_KnockFrontLight_F_01		, // ▶◀(21) (Hit) 왼쪽으로 맞아서 뒤로 넘어진뒤 다시 일어남 - 정면응시
		Sniper_Weakspot_Death_01		, // ▶◀(22) (Death)
		Sniper_Stun_Loop				, // ▶◀(23) (Hit)
		Sniper_Burn_Loop_TEMP			, // ▶◀(24) (Hit)
