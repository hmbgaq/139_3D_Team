...
/* 체력 프레임 */
class CUI_LevelFont final : public CUI_Text
{
	enum TEXTUREKIND { SHIELD_FRAME, TEXTURE_END };

private:
	CUI_LevelFont(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const wstring& strPrototypeTag);
	CUI_LevelFont(const CUI_LevelFont& rhs);
	virtual ~CUI_LevelFont() = default;
