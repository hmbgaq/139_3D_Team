...
public:
	enum Player_State
	{
		...
		Player_Finisher_Bandit_01_							   ,
		Player_Finisher_Bandit_02_							   ,
		Player_Finisher_Bandit_03_							   ,
		Player_Finisher_Bandit_04_							   ,
		Player_Finisher_Bandit_05_							   ,
		Player_Finisher_Bandit_06_							   ,
		Player_Finisher_Bandit_ZapperPull_					   ,
		Player_Finisher_Bandit_ZapperPull_02_				   ,
		Player_Finisher_Bandit_ZapperPull_03_				   ,
		Player_Finisher_Infected_01_							   ,
		Player_Finisher_Infected_02_							   ,
		Player_Finisher_Infected_03_							   ,
		Player_Finisher_Infected_04_							   ,
		Player_Finisher_Infected_ZapperLeap_					   ,
		Player_Finisher_Infected_ZapperPull_					   ,
		Player_TakedownRevolver_ManHero_01_					   ,
		...
		Player_Winchester_Ironsights_Idle					   ,
		...
		Player_Revolver_Hip_FireFullMagazine				   ,
		Player_Revolver_Hip_AO_F							   ,
