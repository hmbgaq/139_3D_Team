...
class CBanditHeavy_HitNormalToStun_01 : public CBandit_Heavy_State_Hit
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Heavy::Bandit_Heavy_State::BanditHeavy_HitNormalToStun_01;
