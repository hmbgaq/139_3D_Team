...
class CSniper_Introduction_03 : public CBandit_Sniper_State_Idle
{
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Sniper_Introduction_03;
