...
class CSniper_DeathLight_B_01 : public CBandit_Sniper_State_Hit
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Sniper_DeathLight_B_01;
