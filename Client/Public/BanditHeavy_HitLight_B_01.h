...
class CBanditHeavy_HitLight_B_01 : public CBandit_Heavy_State_Hit
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Heavy::Bandit_Heavy_State::BanditHeavy_HitLight_B_01;
