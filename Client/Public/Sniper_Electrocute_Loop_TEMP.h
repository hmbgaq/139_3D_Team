...
BEGIN(Client)
class CSniper_Electrocute_Loop_TEMP : public CBandit_Sniper_State_Hit
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Sniper_Electrocute_Loop_TEMP;
