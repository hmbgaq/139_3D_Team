...
class CVampireCommander_Taunt1 : public CVampireCommander_Taunt
{
public:
...
public:
	static const _uint g_iAnimIndex = CVampireCommander::VampireCommander_State::VampireCommander_Taunt_01;
