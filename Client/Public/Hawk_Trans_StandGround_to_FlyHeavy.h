...
class CHawk_Trans_StandGround_to_FlyHeavy : public CHawk_State_Normal
{
public:
...
public:
	static const _uint g_iAnimIndex = CHawk::Hawk_State::Hawk_Trans_StandGround_to_FlyHeavy;
