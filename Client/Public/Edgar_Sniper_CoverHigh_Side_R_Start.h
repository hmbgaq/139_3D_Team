...
class CEdgar_Sniper_CoverHigh_Side_R_Start : public CEdgar_State_Cover_High
{
public:
...
public:
	static const _uint g_iAnimIndex = CEdgar::Edgar_State::Edgar_Sniper_CoverHigh_Side_R_Start;
