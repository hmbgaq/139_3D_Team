...
class CEdgar_Sniper_CoverLow_Over_Stop : public CEdgar_State_Cover_Low_Over
{
public:
...
public:
	static const _uint g_iAnimIndex = CEdgar::Edgar_State::Edgar_Sniper_CoverLow_Over_Stop;
