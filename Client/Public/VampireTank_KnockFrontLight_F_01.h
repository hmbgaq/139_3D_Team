...
class CVampireTank_KnockFrontLight_F_01 : public CBandit_Heavy_State_Knock
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Heavy::Bandit_Heavy_State::VampireTank_KnockFrontLight_F_01;
