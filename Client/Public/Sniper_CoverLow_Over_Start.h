...
class CSniper_CoverLow_Over_Start : public CBandit_Sniper_State_Cover
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Sniper_CoverLow_Over_Start;
