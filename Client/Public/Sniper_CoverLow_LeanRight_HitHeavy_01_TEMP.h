...
class CSniper_CoverLow_LeanRight_HitHeavy_01_TEMP : public CBandit_Sniper_State_Hit
{
public:
...
public:
	static const _uint g_iAnimIndex = CBandit_Sniper::Bandit_Sniper_State::Sniper_CoverLow_LeanRight_HitHeavy_01_TEMP;
