...
class CInfected_HitNormal_FR90_01_NEW : public CInfected_State_Hit
{
public:
...
public:
	static const _uint g_iAnimIndex = CInfected::Infected_State::Infected_HitNormal_FR90_01_NEW;
