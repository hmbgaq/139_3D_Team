...
class CVampireCommander_Walk_BL135 : public CVampireCommander_State_Walk
{
public:
...
public:
	static const _uint g_iAnimIndex = CVampireCommander::VampireCommander_State::VampireCommander_Walk_BL135;
