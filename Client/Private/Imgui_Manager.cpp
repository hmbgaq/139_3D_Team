...
#pragma region 맵툴
	...
	pWindow->SetUp_ImGuiDESC(u8"맵툴", ImVec2{ 200.f, 200.f }, ImGuiWindowFlags_MenuBar | ImGuiWindowFlags_NoDocking | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoBringToFrontOnFocus | ImGuiWindowFlags_NoNavFocus, ImVec4(0.f, 0.f, 0.f, 1.f));
...
#pragma region 이펙트툴
	...
	pWindow->SetUp_ImGuiDESC(u8"이펙트 툴", ImVec2{ 300.f, 680.f }, ImGuiWindowFlags_MenuBar  /*ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove |*/ /* | ImGuiWindowFlags_NoDocking | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoBringToFrontOnFocus*/, ImVec4(0.f, 0.f, 0.f, 1.f));
