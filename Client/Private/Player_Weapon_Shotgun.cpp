...
CPlayer_Weapon_Shotgun::CPlayer_Weapon_Shotgun(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
...
CPlayer_Weapon_Shotgun* CPlayer_Weapon_Shotgun::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CPlayer_Weapon_Shotgun* pInstance = new CPlayer_Weapon_Shotgun(pDevice, pContext);
