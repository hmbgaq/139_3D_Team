...
#pragma endregion
	...
	//!유정
	FAILED_CHECK(m_pGameInstance->Add_Prototype(TEXT("Prototype_GameObject_Particle_Custom"), CParticle_Custom::Create(m_pDevice, m_pContext, TEXT("Prototype_GameObject_Particle_Custom"))));
