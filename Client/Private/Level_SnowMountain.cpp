...
HRESULT CLevel_SnowMountain::Ready_Layer_Camera(const wstring& strLayerTag)
{
	...
	FAILED_CHECK(m_pGameInstance->Add_CloneObject(LEVEL_SNOWMOUNTAIN, strLayerTag, TEXT("Prototype_GameObject_Camera_Dynamic"), &Desc));

	return S_OK;
}

HRESULT CLevel_SnowMountain::Ready_Layer_Player(const wstring& strLayerTag, void* pArg)
{
...
HRESULT CLevel_SnowMountain::Ready_Layer_Monster(const wstring& strLayerTag, void* pArg)
{
...
{
	FAILED_CHECK(m_pGameInstance->Add_CloneObject(LEVEL_SNOWMOUNTAIN, strLayerTag, TEXT("Prototype_GameObject_Terrain")));
	FAILED_CHECK(m_pGameInstance->Add_CloneObject(LEVEL_SNOWMOUNTAIN, strLayerTag, TEXT("Prototype_GameObject_Sky")));

	//if (FAILED(m_pGameInstance->Add_CloneObject(Level_SnowMountain, strLayerTag, TEXT("Prototype_GameObject_Skydome"))))
	//	return E_FAIL;
...
HRESULT CLevel_SnowMountain::Ready_LandObjects()
{
	CLandObject::LANDOBJECT_DESC	LandObjectDesc{};

	LandObjectDesc.pTerrainBuffer = dynamic_cast<CVIBuffer_Terrain*>(m_pGameInstance->Get_Component(LEVEL_SNOWMOUNTAIN, TEXT("Layer_BackGround"), TEXT("Com_VIBuffer")));
	LandObjectDesc.pTerrainTransform = dynamic_cast<CTransform*>(m_pGameInstance->Get_Component(LEVEL_SNOWMOUNTAIN, TEXT("Layer_BackGround"), TEXT("Com_Transform")));
...
HRESULT CLevel_SnowMountain::Ready_Layer_Building(const wstring& strLayerTag, void* pArg)
{
	FAILED_CHECK(m_pGameInstance->Add_CloneObject(LEVEL_SNOWMOUNTAIN, strLayerTag, TEXT("Prototype_GameObject_ForkLift"), pArg));
