...
void CInfected_Melee_RU_02::Initialize(CInfected* pActor)
{
...
CState<CInfected>* CInfected_Melee_RU_02::Update(CInfected* pActor, _float fTimeDelta)
{
	...
	case CInfected::INFECTED_TYPE::INFECTED_VESSEL_C:
	{
		...
		if (pActor->Is_Inputable_Front(38) && m_bFlags[2] == false)
		{
...
void CInfected_Melee_RU_02::Release(CInfected* pActor)
{
