...
#pragma region Effect_Test	
	...
	{
		CEffect* pEffect = CClone_Manager::GetInstance()->Create_Effect(LEVEL_INTRO, LAYER_EFFECT, "Test_Effect.json");
...
HRESULT CLevel_Intro::Ready_Layer_UI_Player(const wstring& strLayerTag, void* pArg)
{
	return S_OK;
}
