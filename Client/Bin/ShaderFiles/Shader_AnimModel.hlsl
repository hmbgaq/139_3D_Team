...
PS_OUT PS_MAIN(PS_IN In)
{
    ...
    Out.vRimBloom = Calculation_Brightness(Out.vDiffuse) + vRimColor; /* Rim & Bloom 둘다 들어가는곳임 
	                /* g_vBloomPower */ 
    
    // Out.vDiffuse += vRimColor; // 효과 약하게 하고싶으면 Bloom에 넣지말고 여기에 넣기 - 블러 적용안된채로 그대로 나감 
    return Out;
}
