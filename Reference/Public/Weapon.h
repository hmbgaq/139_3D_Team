...
public:
	...
	virtual void Play_Weapon_Sound_UnHolster() {};
	virtual void Play_Weapon_Sound_Holster() {};
	virtual void Play_Weapon_Sound_Aim() {};
	virtual void Play_Weapon_Sound_Reload() {};
	virtual void Play_Weapon_Sound_Fire() {};
