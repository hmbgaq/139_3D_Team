...
HRESULT CRenderer::Ready_DebugRender()
{
	...
	/* MRT_FXAA */
	FAILED_CHECK(m_pGameInstance->Ready_RenderTarget_Debug(TEXT("Target_FXAA"),			(g_iWinsizeX - fSizeX * 0.5f), (fSizeY / 2.f * 1.f), fSizeX, fSizeY));
...
HRESULT CRenderer::Render_Debug()
{
	...
	//m_pGameInstance->Render_Debug_RTVs(TEXT("MRT_FXAA"), m_pShader[SHADER_TYPE::SHADER_DEFERRED], m_pVIBuffer);
